 ...
 */
public class RBFNeuralNetTest implements IRBFNeuralNet {

    /**
     * Adds 1 additional input units for bias. Adds 1 additional hidden unit for
     * bias
     */
    public RBFNeuralNetTest(int _I, int _J, int _K) {
        I = _I;
        J = _J;
        K = _K;
    ...
    public Neuron[][] getNetworkLayers() {
        //remove this won't be used for this NN
        return null;
    }
     ...
     * @return distance
     */
    private double distanceBetweenVectors(double[] v1, double[] v2) {
        double distance = 0;
